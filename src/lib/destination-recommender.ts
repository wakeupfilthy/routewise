...
const destinos = [
    ...
    { destino: 'Kioto, Japón', tipo_viaje: [ 'culturales', 'gastronomia', 'naturaleza', 'festivales' ], costo_estimado: 313, ideal_para: 'En Pareja' },
    { destino: 'Oaxaca de Juárez, México', tipo_viaje: [ 'culturales', 'gastronomia', 'festivales' ], costo_estimado: 100, ideal_para: 'Solo' },
    { destino: 'Bangkok, Tailandia', tipo_viaje: [ 'culturales', 'gastronomia', 'vidaNocturna' ], costo_estimado: 163, ideal_para: 'Con Amigos' },
    { destino: 'Buenos Aires, Argentina', tipo_viaje: [ 'culturales', 'gastronomia', 'vidaNocturna' ], costo_estimado: 163, ideal_para: 'En Pareja' },
    { destino: 'Riviera Maya, México', tipo_viaje: [ 'playas', 'naturaleza', 'spa' ], costo_estimado: 250, ideal_para: 'En Familia' },
    { destino: 'Roma, Italia', tipo_viaje: [ 'culturales', 'gastronomia', 'compras' ], costo_estimado: 338, ideal_para: 'En Pareja' },
    ...
    { destino: 'Medellín, Colombia', tipo_viaje: [ 'culturales', 'vidaNocturna', 'naturaleza' ], costo_estimado: 81, ideal_para: 'Con Amigos' },
    { destino: 'Lisboa, Portugal', tipo_viaje: [ 'culturales', 'gastronomia', 'vidaNocturna' ], costo_estimado: 238, ideal_para: 'En Pareja' },
    { destino: 'Praga, República Checa', tipo_viaje: [ 'culturales', 'vidaNocturna', 'compras' ], costo_estimado: 250, ideal_para: 'Con Amigos' },
    { destino: 'Chiang Mai, Tailandia', tipo_viaje: [ 'culturales', 'naturaleza', 'gastronomia', 'spa' ], costo_estimado: 131, ideal_para: 'Solo' },
    { destino: 'Cusco, Perú', tipo_viaje: [ 'culturales', 'naturaleza', 'gastronomia' ], costo_estimado: 138, ideal_para: 'Solo' },
    ...
    { destino: 'Viena, Austria', tipo_viaje: [ 'culturales', 'gastronomia', 'festivales' ], costo_estimado: 244, ideal_para: 'En Pareja' },
    { destino: 'Ciudad del Cabo, Sudáfrica', tipo_viaje: [ 'naturaleza', 'culturales', 'gastronomia', 'playas' ], costo_estimado: 238, ideal_para: 'En Pareja' },
    { destino: 'Río de Janeiro, Brasil', tipo_viaje: [ 'playas', 'vidaNocturna', 'naturaleza', 'festivales' ], costo_estimado: 185, ideal_para: 'Con Amigos' },
    { destino: 'Dublín, Irlanda', tipo_viaje: [ 'culturales', 'vidaNocturna', 'gastronomia' ], costo_estimado: 263, ideal_para: 'Con Amigos' },
    { destino: 'Mérida, México', tipo_viaje: [ 'culturales', 'gastronomia', 'naturaleza' ], costo_estimado: 100, ideal_para: 'En Familia' },
    { destino: 'Marrakech, Marruecos', tipo_viaje: [ 'culturales', 'gastronomia', 'vidaNocturna' ], costo_estimado: 106, ideal_para: 'Solo' },
    ...
    { destino: 'San Sebastián, España', tipo_viaje: [ 'gastronomia', 'playas', 'culturales' ], costo_estimado: 275, ideal_para: 'En Pareja' },
    { destino: 'Florencia, Italia', tipo_viaje: [ 'culturales', 'gastronomia' ], costo_estimado: 238, ideal_para: 'En Pareja' },
    { destino: 'Edimburgo, Escocia', tipo_viaje: [ 'culturales', 'vidaNocturna', 'festivales' ], costo_estimado: 288, ideal_para: 'Con Amigos' },
    { destino: 'Oporto, Portugal', tipo_viaje: [ 'culturales', 'gastronomia', 'vidaNocturna' ], costo_estimado: 138, ideal_para: 'En Pareja' },
    { destino: 'Chicago, Estados Unidos', tipo_viaje: [ 'gastronomia', 'festivales', 'vidaNocturna' ], costo_estimado: 313, ideal_para: 'Con Amigos' },
    { destino: 'Cartagena, Colombia', tipo_viaje: [ 'playas', 'culturales', 'vidaNocturna' ], costo_estimado: 150, ideal_para: 'En Pareja' },
    { destino: 'Valencia, España', tipo_viaje: [ 'culturales', 'gastronomia', 'playas' ], costo_estimado: 175, ideal_para: 'En Familia' },
    { destino: 'Budapest, Hungría', tipo_viaje: [ 'culturales', 'vidaNocturna', 'gastronomia' ], costo_estimado: 200, ideal_para: 'Con Amigos' },
    ...
    { destino: 'Berlín, Alemania', tipo_viaje: [ 'culturales', 'vidaNocturna', 'festivales' ], costo_estimado: 188, ideal_para: 'Con Amigos' },
    { destino: 'Lima, Perú', tipo_viaje: [ 'gastronomia', 'culturales' ], costo_estimado: 88, ideal_para: 'Solo' },
    { destino: 'Sídney, Australia', tipo_viaje: [ 'playas', 'naturaleza', 'vidaNocturna' ], costo_estimado: 250, ideal_para: 'Con Amigos' },
    { destino: 'Estocolmo, Suecia', tipo_viaje: [ 'culturales', 'naturaleza', 'gastronomia' ], costo_estimado: 225, ideal_para: 'En Pareja' },
    { destino: 'Nueva Orleans, Estados Unidos', tipo_viaje: [ 'gastronomia', 'festivales', 'vidaNocturna', 'culturales' ], costo_estimado: 275, ideal_para: 'Con Amigos' },
    { destino: 'Cracovia, Polonia', tipo_viaje: [ 'culturales', 'vidaNocturna' ], costo_estimado: 100, ideal_para: 'Solo' },
    { destino: 'Ho Chi Minh, Vietnam', tipo_viaje: [ 'gastronomia', 'culturales', 'vidaNocturna' ], costo_estimado: 69, ideal_para: 'Solo' },
    { destino: 'Atenas, Grecia', tipo_viaje: [ 'culturales', 'gastronomia', 'playas' ], costo_estimado: 163, ideal_para: 'En Pareja' },
    { destino: 'Bali, Indonesia', tipo_viaje: [ 'naturaleza', 'playas', 'culturales' ], costo_estimado: 113, ideal_para: 'En Pareja' },
    { destino: 'Vancouver, Canadá', tipo_viaje: [ 'naturaleza', 'gastronomia', 'culturales' ], costo_estimado: 238, ideal_para: 'En Familia' },
    { destino: 'Zanzíbar, Tanzania', tipo_viaje: [ 'playas', 'culturales', 'naturaleza' ], costo_estimado: 138, ideal_para: 'En Pareja' }
