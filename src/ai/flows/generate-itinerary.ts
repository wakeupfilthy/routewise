...
const prompt = ai.definePrompt({
  ...
  **Tareas:**
  ...
  3.  **Generar un resumen de costos:** Proporciona un rango de precios estimado en USD para: vuelos, alojamiento, transporte local, alimentación, actividades y entradas, extras y contingencia, y un total. Sé realista con los costos basándote en el destino y el presupuesto indicado. Incluye el código de la moneda "USD" en cada valor.
